...
const dsl_shader_entry_t dsl_shader_registry[] = {
    { .name = "aurora", .folder = "/native/ambient", .eval_pixel = aurora_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "aurora-ribbons-classic", .folder = "/native/ambient", .eval_pixel = aurora_ribbons_classic_eval_pixel, .has_frame_func = 1, .eval_frame = aurora_ribbons_classic_eval_frame, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "campfire", .folder = "/native/nature", .eval_pixel = campfire_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "chaos-nebula", .folder = "/native/energetic", .eval_pixel = chaos_nebula_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "dream-weaver", .folder = "/native/ambient", .eval_pixel = dream_weaver_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "electric-arcs", .folder = "/native/energetic", .eval_pixel = electric_arcs_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "forest-wind", .folder = "/native/nature", .eval_pixel = forest_wind_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 1, .eval_audio = forest_wind_eval_audio, .phasor_count = 0 },
    { .name = "gradient", .folder = "/native/ambient", .eval_pixel = gradient_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "heartbeat-pulse", .folder = "/native/audio", .eval_pixel = heartbeat_pulse_eval_pixel, .has_frame_func = 1, .eval_frame = heartbeat_pulse_eval_frame, .has_audio_func = 1, .eval_audio = heartbeat_pulse_eval_audio, .phasor_count = 0 },
    { .name = "infinite-lines", .folder = "/native/geometric", .eval_pixel = infinite_lines_eval_pixel, .has_frame_func = 1, .eval_frame = infinite_lines_eval_frame, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "lava-lamp", .folder = "/native/ambient", .eval_pixel = lava_lamp_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "ocean-waves", .folder = "/native/nature", .eval_pixel = ocean_waves_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "primal-storm", .folder = "/native/energetic", .eval_pixel = primal_storm_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "rain-matrix", .folder = "/native/energetic", .eval_pixel = rain_matrix_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "rain-ripple", .folder = "/native/nature", .eval_pixel = rain_ripple_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "soap-bubbles", .folder = "/native/ambient", .eval_pixel = soap_bubbles_eval_pixel, .has_frame_func = 1, .eval_frame = soap_bubbles_eval_frame, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "spiral-galaxy", .folder = "/native/cosmic", .eval_pixel = spiral_galaxy_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "starfield", .folder = "/native/cosmic", .eval_pixel = starfield_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 0, .eval_audio = (float(*)(float,float,float,float*))0, .phasor_count = 0 },
    { .name = "tone-pulse", .folder = "/native/audio", .eval_pixel = tone_pulse_eval_pixel, .has_frame_func = 1, .eval_frame = tone_pulse_eval_frame, .has_audio_func = 1, .eval_audio = tone_pulse_eval_audio, .phasor_count = 0 },
};
