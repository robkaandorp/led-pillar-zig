...
const dsl_shader_entry_t dsl_shader_registry[] = {
    ...
    { .name = "forest-wind", .folder = "/native/nature", .eval_pixel = forest_wind_eval_pixel, .has_frame_func = 0, .eval_frame = (void(*)(float,float))0, .has_audio_func = 1, .eval_audio = forest_wind_eval_audio, .phasor_count = 0, .target_fps = 0 },
